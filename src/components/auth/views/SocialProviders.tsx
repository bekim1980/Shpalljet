...
import { authSocialButtonClass } from "@/components/auth/authStyles";
...
const FacebookIcon = () => (
  <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="#1877F2" aria-hidden>
...
const SocialProviders = ({
  ...
  if (!hasVisibleSocialProviders()) return null;
